...
<body>
    ...
    <section class="order-container">
        ...
        <div class="box-container">
            <?php
            $select_orders = mysqli_query($conn,"SELECT * FROM `orders`") or dir('query failed');
                ...
                while($fetch_orders = mysqli_fetch_assoc($select_orders)){
                    ...
                    <div class="box">
                        ...
                        <form method="post">
                            ...
                            <a href="admin_orders.php?delete=<?php echo $fetch_orders['id'];?>" class="delete" onclick="return conform('Are you sure to delete thsi ?')">delete</a>
                        </form>
                    </div>
                    <?php
                }
