    ...
    <section class="dashboard">
        ...
        <div class="box-container">
            ...
            <div class="box">
                ...
                $no_of_orders = mysqli_num_rows($select_orders);
                ?>
                <h3><?php echo $total_pendings; ?></h3>
                <p>order placed</p>
            </div>
            ...
            <div class="box">
                ...
                $no_of_admins = mysqli_num_rows($select_admins);
                ?>
                <h3><?php echo $no_of_admins; ?></h3>
                <p>total admins</p>
            </div>
            ...
            <div class="box">
                ...
                $no_of_totalusers = mysqli_num_rows($select_totalusers);
                ?>
                <h3><?php echo $no_of_totalusers; ?></h3>
                <p>total users</p>
            </div>
        </div>
